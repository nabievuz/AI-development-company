...
<!-- GENERATED by scripts/gen_agent_templates.py (ADR-0029 G-1..G-5). SEED from
     governance/agents/ceo/AGENTS.md + governance/policies/model-allocation.md
...
- Never review your own work: set `in_review` and hand off to your reviewer per
  `board/ROUTING.md` (Chairman of the Board).
...
## Eval baseline
- `evals/ceo/` — golden-eval harness + scorecard (WS6 O6-T04 / O6-T05); the bar
