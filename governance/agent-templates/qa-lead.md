...
# Guild template — QA Lead

<!-- GENERATED by scripts/gen_agent_templates.py (ADR-0029 G-1..G-5). SEED from
     engineering/agents/qa-lead/AGENTS.md + governance/policies/model-allocation.md
...
## Eval baseline
- `evals/qa-lead/` — golden-eval harness + scorecard (WS6 O6-T04 / O6-T05); the bar
