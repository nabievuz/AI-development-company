...
import check_break_glass_review as cr
...
def test_late_review_fails(tmp_path):
    p = _store(tmp_path, [_act(), _review(created="2026-06-23T11:00:00Z")])
...
def test_predated_review_does_not_satisfy(tmp_path):
    ...
    r1 = _review(created="2020-01-01T00:00:00Z")
...
def test_overlapping_windows_pass_regardless_of_review_order(tmp_path):
    ...
    r_shared = _review(aid="BG-y", created="2026-06-22T10:45:00Z")
    r_a1only = _review(aid="BG-y", created="2026-06-22T10:15:00Z")
