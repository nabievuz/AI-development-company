...
- **Status:** ✅ **FOUNDER-APPROVED 2026-07-23** (`APPROVED`). Order 0 (prep) + order 1 (WS-A REACH) decomposed to `board/tickets/` DAS-1541…DAS-1551; WS-B…WS-F remain `founder_approved`, decomposed one at a time as each predecessor's ADR is ratified.
